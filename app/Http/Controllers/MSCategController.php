...
class MSCategController extends Controller
{
    ...
    public function lookup(Request $request)
    {
        ...
        try {
            $results = DB::select(
                'EXEC sproc_PHP_MSCateg @mode = ?, @params = ?',
                ['Lookup', $params]
            );
    ...
    public function delete(Request $request)
    {
        ...
        $code = $data['code'] ?? null; // using 'code' to match React frontend state
