...
public function upsert(Request $request)
{
        ...
        try {
            ...
            $result = DB::select('EXEC sproc_PHP_AR @mode = ?, @params = ?', [
                $mode,
                $params
            ]);
...
public function finalize(Request $request) {
    ...
    try {
       ...
       $validated = $request->validate([
        ...
        $results = DB::select(
            'EXEC sproc_PHP_Posting_AR @mode = ?, @params = ?',
            ['Finalize', $params]
        );
...
public function generateGL(Request $request)
    {
        try {
            ...
            $results = DB::select("EXEC sproc_PHP_AR @mode = ?, @params = ?", [
                'GenerateEntries',
                $jsonString
            ]);
            ...
            Log::error('Error executing sproc_PHP_AR: ' . $e->getMessage());
            return response()->json([
                'status' => 'error',
