...
class POController extends Controller
{
    ...
    public function cancel(Request $request)
    {
        ...
        try {
            ...
            // 🔥 THE CRITICAL FIX: Translate 'documentID' to 'poId' for the Sproc
            if (isset($jsonData['documentID'])) {
                $jsonData['poId'] = $jsonData['documentID'];
            }
            ...
            return response()->json([
                'status' => 'error',
                'message' => 'Error executing PO Cancel.',
                'details' => $e->getMessage()
            ], 500);
        }
    }
