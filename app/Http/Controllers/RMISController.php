...
class RMISController extends Controller
{
...
public function index(Request $request) {
    ...
    try {
        ...
        $results = DB::select(
            'EXEC sproc_PHP_RMIS @mode = ?, @params = ?',
            ['get' ,$params] 
        );
...
public function upsert(Request $request)
{
        ...
        try {
            ...
            $result = DB::select('EXEC sproc_PHP_RMIS @mode = ?, @params = ?', [
                $mode,
                $params
            ]);
...
public function finalize(Request $request) {
    ...
    try {
       ...
       $validated = $request->validate([
        ...
        $results = DB::select(
            'EXEC sproc_PHP_Posting_RMIS @mode = ?, @params = ?',
            ['Finalize', $params]
        );
...
public function generateGL(Request $request)
    {
        try {
            ...
            $results = DB::select("EXEC sproc_PHP_RMIS @mode = ?, @params = ?", [
                'GenerateEntries',
                $jsonString
            ]);
            ...
            Log::error('Error executing sproc_PHP_RMIS: ' . $e->getMessage());
            return response()->json([
                'status' => 'error',
 ...
 public function msLookup(Request $request)
    {
        ...
        $rows = DB::select(
            "EXEC dbo.sproc_PHP_INVLookup_RM @mode = ?, @params = ?",
            [$mode, $params]
        );
